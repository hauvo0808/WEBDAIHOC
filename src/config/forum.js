...
export const SEED_QUESTIONS = [
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        ...
        authorEmail: 'hangday@hcmut.edu.vn',
        authorSchool: 'Đại học Bách Khoa TP.HCM',
  ...
  },
  {
    ...
    createdAt: Date.now() - 1000 * 60 * 30*20,
    answers: [
      {
        id: 6,
        authorName: 'An An là mặt trời nhỏ',
        authorEmail: 'AnAn@ump.edu.vn',
        authorSchool: 'ĐH Y Dược TP.HCM',
        content: 'Tùy nhoa bé uii, chị học ngành y tầm 99tr á em :3',
        createdAt: Date.now() - 1000 * 60 * 60 * 17,
      },
      {
        id: 4,
        authorName: 'Long nón lá',
        authorEmail: 'Llong@ump.edu.vn',
        authorSchool: 'ĐH Y Dược TP.HCM',
        content: ' dao động từ 80 đến khoảng 120tr đó bé',
        createdAt: Date.now() - 1000 * 60 * 60 * 17,
      },
    ],
  },
  {
    id: 6,
    authorName: 'Nguyễn Thành Chiến',
    content: 'Học bạ 29+ có đậu được ngành kdqt ở ufm ko ạ ?',
    createdAt: Date.now() - 1000 * 60 * 30*24,
    answers: [
      {
        id: 6,
        authorName: 'Long siêu nhân',
        authorEmail: 'Longne@ufm.edu.vn',
        authorSchool: 'ĐH tài chính marketing ',
        content: 'pick me boy hả bé, anh 24 đã đậu r nè :))',
        createdAt: Date.now() - 1000 * 60 * 60 * 24,
      },
      {
        id: 4,
